<div class="axytos-agreement-link ms-4 mt-2 small">
  By selecting this payment method, you agree to our
  <a href="{$axytos_agreement_link}" class="agreement-link">payment terms and conditions</a>
</div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="agreementModalLabel">Payment Terms and Conditions</h5>
